...
//
// Ported from FutureSDR `examples/lora` (GPL-3.0-only). Original
// upstream by the FutureSDR contributors and Tapparel et al.
// (`gr-lora_sdr`).
